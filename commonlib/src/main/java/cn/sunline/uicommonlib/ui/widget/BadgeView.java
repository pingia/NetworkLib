...
public class BadgeView extends TextView {
	...
	private void init(Context context, View target, int tabIndex) {
		...
		// apply defaults
		badgeCornerRadius = DEFAULT_CORNER_RADIUS_DIP;
		...
		setLRPaddingDip(DEFAULT_LR_PADDING_DIP);
	...
	private void show(boolean animate, Animation anim) {
		...
		if(null != target) {		//只有在粘附其他视图时才应用FrameLayout布局
			applyLayoutParams();
		}
	...
	private ShapeDrawable getDefaultBackground() {
		...
		int r = dipToPixels(badgeCornerRadius);
	...
	public void setLRPaddingDip(int paddingDiP){
		int paddingPixels = dipToPixels(paddingDiP);
		setPadding(paddingPixels, 0, paddingPixels, 0);
	}

	public void setCornerRadiusDip(int radiusDip){
		this.badgeCornerRadius = radiusDip;
	}
